...
def conectar_banco():
    # Garanta que a sua senha real está no lugar dos asteriscos logo após o 'neondb_owner:'
    ...
    # Mudamos apenas esta linha abaixo para usar 'dsn='
...
if menu == "📊 Dashboard & Alertas":
    ...
    try:
        conn = conectar_banco()
        # Veja que o query está com o mesmo recuo do 'conn'
...
# =========================================================
    ...
    try:
        conn = conectar_banco()
        # Ajustado para padrão Postgres/Neon (TO_CHAR e aspas duplas nos apelidos)
        query_hist = """
